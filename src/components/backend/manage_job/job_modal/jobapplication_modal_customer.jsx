      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <Form onSubmit={handleSubmit} className="space-y-4">
          <Form.Group controlId="formJobApplicationJobPostingId">
            <Form.Label className="text-sm font-medium text-gray-700">Seleccionar Publicación de Trabajo</Form.Label>
            <Form.Control
              as="select"
              value={jobPostingId}
          ...
          <Form.Group controlId="formJobApplicationApplicant">
            <Form.Label className="text-sm font-medium text-gray-700">Seleccionar Correo Electrónico del Solicitante</Form.Label>
            <Form.Control
              as="select"
          ...
          <Form.Group controlId="formJobApplicationCoverLetter">
            <Form.Label className="text-sm font-medium text-gray-700">Carta de Presentación</Form.Label>
            <Form.Control
              as="textarea"
              rows={3}
              value={coverLetter}
