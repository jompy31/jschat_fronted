...
import Data from '../../datos_cotizador/datos_colegios/Colegio_contadoresprivados.json';
import numeral from 'numeral';
import '../Cotizador.css';
import { useMediaQuery } from "react-responsive";

const Colegio_contadoresprivados = () => {
                        ...
                        <tbody>
                            {serviciosFiltrados.map((servicio, index) => (
                                <tr key={index}>
                                    ...
                                    <td>{((servicio.precio.replace(',', '').trim()))}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
...
export default Colegio_contadoresprivados;
