...
import Data from '../datos_cotizador/inscripcion_hipoteca.json';
...
const TraspasosBienes = () => {
  ...
  const calcularCotizacion = () => {
    ...
    const cotizacionesOrdenadas = Data.inscripcion_hipoteca
      .map(traspaso => ({
        ...traspaso,
                ...
                <tbody>
                  {cotizacionesCercanas.map((cotizacion, index) => (
                    <tr key={index}>
                      ...
                      <td>{formatNumber(cotizacion.valor_inscripcion)}</td>
                      <td>{cotizacion.valor_inscripcion_dolares}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="modal" onClick={cerrarModal}>
          <div className="modal-content rounded-shadow"
            ...
            <table>
              ...
              <tbody>
                {Data.inscripcion_hipoteca.map((traspaso, index) => (
                  <tr key={index}>
                    ...
                    <td>{traspaso.valor_inscripcion}</td>
                    <td>{traspaso.valor_inscripcion_dolares}</td>
                  </tr>
                ))}
              </tbody>
            </table>
