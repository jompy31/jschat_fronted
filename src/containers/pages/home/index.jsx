...
const Home = () => {
  ...
  const portfolioItems = [
    { src: Foto4, name: 'Uniformes Deportivos' },
    { src: Foto1, name: 'Productos Empresariales' },
    { src: Foto2, name: 'Sublimación' },
    { src: Foto3, name: 'Impresión Láser' },
  ];
    ...
    <div className="home-container">
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <motion.div variants={cardVariants} className="max-w-4xl mx-auto text-center">
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
                ...
                <SwiperSlide key={index}>
                  ...
                  >
                    <img
                      src={item.src}
                      alt={item.name}
                      className="mx-auto rounded-xl group-hover:rounded-2xl transition-all duration-500 shadow-lg hover:shadow-[var(--glow-neon)]
                                 object-contain max-h-64 sm:max-h-72 md:max-h-80 lg:max-h-96 w-full"
                      style={{
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
      {[
        {
          quote:
            "J SPORT superó nuestras expectativas con uniformes de alta calidad para nuestro equipo.",
          author: "Juan Pérez, Entrenador Deportivo",
        },
        {
          quote:
            "Los regalos personalizados para nuestro evento corporativo fueron un éxito gracias a J SPORT.",
          author: "Ana Gómez, Organizadora de Eventos",
        },
        {
          quote:
            "La sublimación en nuestros productos promocionales fue impecable y entregada a tiempo.",
        ...
        <motion.div
          ...
          className="group relative glass-neon bg-transparent p-6 sm:p-8 rounded-xl border border-transparent hover:border-[var(--border-primary)] overflow-hidden cursor-pointer"
        >
