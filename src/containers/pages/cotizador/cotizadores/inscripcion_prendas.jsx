...
const TraspasosBienes = () => {
  ...
  const calcularCotizacion = () => {
    ...
    const cotizacionesOrdenadas = Data.inscripcion_prendas
      .map(traspaso => ({
        ...traspaso,
        ...
        <div className="modal" onClick={cerrarModal}>
          <div className="modal-content rounded-shadow"
            ...
            <table>
              ...
              <tbody>
                {Data.inscripcion_prendas.map((traspaso, index) => (
                  <tr key={index}>
