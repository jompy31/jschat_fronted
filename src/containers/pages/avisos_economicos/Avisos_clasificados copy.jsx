...
const ClasificadosComponent = () => {
  ...
  return (
    ...
    `,
        ...
        <div className="clasificados-container" >
          {[...Array(5)].map((_, columnIndex) => {
            ...
            const clasificadosPorColumna =
              columnIndex === 0 ? 0 : columnIndex === 0 ? 0 : 5;
              ...
              <div key={columnIndex} className="columna">
                ...
                {columnIndex === 0 && (
                  <div className="table-container" >
                    ...
                    <span style={{ color: "red", fontSize: "1.0em", fontWeight: "bold" }}>El click le lleva a ver en Landing Page Menú, precios, imágenes, horarios, forma de entrega, formas de pago en el DIRECTORIO ABcupon.com  </span>
                    ...
                    {clasificadosToUse
                      ...
                      .map((clasificado, index) => {
                        ...
                        `}
                              ...
                              <div style={{ display: "inline-flex", alignItems: "center", fontSize: "0.8em" }}>
        ...
        {clasificadosToUse.filter((_, index) => index >= 20 && index < 45).length > 0 && (
          <div>
            <div className="clasificados-container">
              {[...Array(5)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                const clasificadosPorColumna =
                  columnIndex === 0 ? 5 : columnIndex === 5 ? 5 : 5;
                const maxClasificadosConImagen = 2.2;
                const maxClasificadosSinImagen = 5;
                ...
                return (
                  <div key={columnIndex} className="columna">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 20 && index < 45)
                      .slice(
        ...
        {clasificadosToUse.filter((_, index) => index >= 45 && index < 70).length > 0 && (
          <div>
            <div className="clasificados-container">
              {[...Array(5)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 45 && index < 70)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 70 && index < 95).length > 0 && (
          <div>
              ...
              {[...Array(4)].map((_, columnIndex) => {
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 70 && index < 95)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 95 && index < 120).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 95 && index < 120)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 120 && index < 145).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 120 && index < 145)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 145 && index < 170).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 145 && index < 170)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 170 && index < 195).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 170 && index < 195)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 195 && index < 220).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 195 && index < 220)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 220 && index < 245).length > 0 && (
          <div>
            <div className="clasificados-container1">
              {[...Array(4)].map((_, columnIndex) => {
                let clasificadosEnColumna = 0;
                ...
                return (
                  <div key={columnIndex} className="columna1">
                    ...
                    {clasificadosToUse
                      .filter((_, index) => index >= 220 && index < 245)
                      .slice(
                        columnIndex * clasificadosPorColumna,
                        columnIndex * clasificadosPorColumna +
                        clasificadosPorColumna
        ...
        {clasificadosToUse.filter((_, index) => index >= 245 && index < 270).length > 0 && (
          <div className="clasificados-container1">
            {[...Array(5)].map((_, columnIndex) => {
              let clasificadosEnColumna = 0;
              const clasificadosPorColumna =
              ...
              return (
                <div key={columnIndex} className="columna1">
                  ...
                  {clasificadosToUse
                    .filter((_, index) => index >= 245 && index < 270)
                    .slice(
                      columnIndex * clasificadosPorColumna,
                      columnIndex * clasificadosPorColumna +
                      clasificadosPorColumna
